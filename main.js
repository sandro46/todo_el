...
app.controller('AppCtrl', ['$scope', '$mdDialog', '$mdToast', function($scope, $mdDialog, $mdToast){
	...
	$scope.showAdd = function(ev) {
		$mdDialog.show({
			...
			template: '<md-dialog aria-label="User Form"> \
									<md-content class="md-padding"> \
										<form name="userForm"> \
											<md-input-container> \
												<label>New Task</label> \
												<input ng-model="newTask" placeholder="Placeholder text"> \
											</md-input-container> \
										</form> \
									</md-content> \
									<div class="md-actions" layout="row"> \
										...
										<md-button ng-click="add(newTask)" class="md-primary"> Add task </md-button> \
									</div>\
								</md-dialog>',
			targetEvent: ev,
		})
